...
(function() {
  ...
  Score = (function() {
    ...
    Score.prototype.initialize = function(name, back, front, x, y, total, count) {
      ...
      this.txtTotal.x = this.bmpBack.x + back.width / 2 - this.txtTotal.getMeasuredWidth() / 2;
      this.txtTotal.y = this.bmpBack.y + back.height / 2 - this.txtTotal.getMeasuredHeight() / 2;
      this.txtCount.text = count;
      this.txtCount.x = this.bmpFront.x + front.width / 2 - this.txtCount.getMeasuredWidth() / 2;
