...
(function() {
  ...
  U2A6 = (function(_super) {
      ...
      sounds = [
        {
          ...
          src: 'sounds/TU3_U2_A6_instructions.mp3',
          id: 'instructions'
        }
      ];
    ...
    U2A6.prototype.setBoard = function() {
      var board, i, v, _i;
    ...
    U2A6.prototype.setQuestion = function() {
