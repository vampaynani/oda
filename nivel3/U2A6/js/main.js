...
(function() {
  ...
  U2A6 = (function(_super) {
    ...
    function U2A6() {
      this.manifest = [
        {
          ...
          src: 'TU3_U2_A6_instructions.mp3',
          id: 's/instructions'
        }
      ];
      this.game = {
        ...
        instructions: {
          ...
          states: [
            {
              text: 'Look and click on the correct options. Careful! You are only allowed two errors!',
            ...
            containers: [
              {
                ...
                cells: [
                  {
                    txt: 'How many are there?',
                    img: 'objectEggs',
                    success: 'arenone'
                  }, {
                    txt: 'How many are there?',
                    img: 'objectBlueberries',
                    success: 'arelot'
                  }, {
                    txt: 'How much is there?',
                    img: 'objectMeat1',
                    success: 'islittle'
                  }, {
                    txt: 'How much is there?',
      ...
      U2A6.__super__.constructor.call(this);
    }
