...
(function() {
  ...
  U3A6 = (function(_super) {
    ...
    function U3A6() {
      this.manifest = [
        {
          ...
          src: 'TU3_U3_A6_instructions.mp3',
          id: 's/instructions'
        }
      ];
      this.game = {
        ...
        instructions: {
          ...
          states: [
            {
              text: 'Look and drag the letters to complete the crossword puzzle.',
                ...
                [
                  {
                    name: 'cwd1',
                    opts: {
                      matrix: [['#', '#', '#', '#', '#', '#', '#', '#', 'p', '#', '#', '#', '#', '#'], ['#', '#', '#', '#', '#', '#', '#', '#', 'l', '#', '#', '#', '#', '#'], ['#', '#', '#', '#', '#', '#', '#', 'd', 'a', 'n', 'c', 'i', 'n', 'g'], ['#', '#', '#', '#', '#', '#', '#', '#', 'y', '#', '#', '#', '#', '#'], ['#', '#', '#', '#', '#', '#', 'm', '#', 'i', '#', 's', '#', '#', '#'], ['#', '#', '#', '#', '#', 'p', 'a', 'i', 'n', 't', 'i', 'n', 'g', '#'], ['#', '#', '#', '#', '#', '#', 'k', '#', 'g', '#', 'n', '#', '#', '#'], ['#', '#', '#', '#', '#', '#', 'i', '#', '-', '#', 'g', '#', '#', '#'], ['#', '#', '#', '#', '#', '#', 'n', '#', 't', '#', 'i', '#', '#', '#'], ['c', 'o', 'o', 'k', 'i', 'n', 'g', '#', 'h', '#', 'n', '#', '#', '#'], ['#', '#', '#', '#', '#', '#', '-', '#', 'e', '#', 'g', '#', '#', '#'], ['#', '#', '#', '#', '#', '#', 'c', '#', '-', '#', '#', '#', '#', '#'], ['#', '#', '#', '#', '#', '#', 'r', '#', 'f', '#', '#', '#', '#', '#'], ['#', '#', '#', '#', '#', '#', 'a', '#', 'l', '#', '#', '#', '#', '#'], ['#', '#', '#', '#', '#', '#', 'f', '#', 'u', '#', '#', '#', '#', '#'], ['#', '#', '#', '#', '#', '#', 't', '#', 't', '#', '#', '#', '#', '#'], ['#', '#', '#', '#', '#', '#', 's', '#', 'e', '#', '#', '#', '#', '#']],
                      words: [
                        {
                          x: 165,
                          y: -25,
      ...
      U3A6.__super__.constructor.call(this);
    }
