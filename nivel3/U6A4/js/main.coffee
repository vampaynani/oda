...
class U6A4 extends Oda
	constructor: ->
		@manifest = [
			...
			{src:'TU3_U6_A4_instructions.mp3', id:'s/instructions'}
		]
		@game = 
			header: 'head'
			instructions: {x: 40, y: 100, states: [{text:'Choose the correct answers to the questions.', sound:'s/instructions', played: false}]}
						...
						collection: [
							[
								{name:'global', opts:{success:1}}
								{
									...
									img: {name: 'image7', x: 20, y: 100, scale: 0.5}
									opt1: 'Yes, it did.', opt2: 'No, it didn\'t.'}
								}
							]
							[
								{name:'global', opts:{success:2}}
								{
									...
									img: {name: 'image2', x: 20, y: 40, scale: 0.5}
									opt1: 'Yes, it did.', opt2: 'No, it didn\'t.'}
								}
							]
							[
								{name:'global', opts:{success:2}}
								{
									...
									img: {name: 'image9', x: 20, y: 80, scale: 0.5}
									opt1: 'Yes, it did.', opt2: 'No, it didn\'t.'}
								}
							]
							[
								{name:'global', opts:{success:2}}
								{
									...
									img: {name: 'image5', x: 20, y: 80, scale: 0.5}
									opt1: 'Yes, it did.', opt2: 'No, it didn\'t.'}
								}
							]
							[
							...
							[
								{name:'global', opts:{success:1}}
								{
									...
									img: {name: 'image3', x: 20, y: 60, scale: 0.5}
									opt1: 'Yes, it did.', opt2: 'No, it didn\'t.'}
								}
							]
							[
								{name:'global', opts:{success:2}}
								{
									...
									img: {name: 'image1', x: 20, y: 70, scale: 0.45}
									opt1: 'Yes, it did.', opt2: 'No, it didn\'t.'}
								}
							]
							[
								{name:'global', opts:{success:1}}
								{
									...
									img: {name: 'image4', x: 20, y: 60, scale: 0.45}
									opt1: 'Yes, it did.', opt2: 'No, it didn\'t.'}
								}
							]
							[
