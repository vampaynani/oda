...
(function() {
  ...
  U4A6 = (function(_super) {
    ...
    U4A6.prototype.setStage = function() {
      var caras, dontlike, hate, like, love;
      U4A6.__super__.setStage.apply(this, arguments);
      this.insertBitmap('header', 'head', stageSize.w / 2, 0, 'tc');
      this.insertBitmap('instructions', 'inst', 20, 100);
      this.insertBitmap('fondo', 'fondo', stageSize.w / 2, 130, 'tc');
      this.insertBitmap('btnrepeat', 'btnrepeat', 485, 550);
      this.insertBitmap('btnfinished', 'btnfinished', 610, 550);
      caras = new createjs.Container();
      love = new Draggable('dragblelove', this.preload.getResult('dragblelove'), 1, 160, 540);
      like = new Draggable('dragblelike', this.preload.getResult('dragblelike'), 1, 230, 540);
      dontlike = new Draggable('dragbledontlike', this.preload.getResult('dragbledontlike'), 1, 300, 540);
      hate = new Draggable('dragblehate', this.preload.getResult('dragblehate'), 1, 370, 540);
