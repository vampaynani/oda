      ...
      this.manifest = [
        {
          ...
          src: 'TU3_U3_A1_instructions.mp3',
          id: 's/instructions'
        }, {
          src: 'TU3_U3_A1_bella.mp3',
          id: 's/che1'
        }, {
          src: 'TU3_U3_A1_aiden.mp3',
          id: 's/che2'
        }, {
          src: 'TU3_U3_A1_paisley.mp3',
          id: 's/che3'
        }, {
          src: 'TU3_U3_A1_jacob.mp3',
          id: 's/che4'
        }
      ];
      this.game = {
        ...
        instructions: {
          ...
          states: [
            {
              text: 'Listen and drag the faces to the correct place on the chart.',
