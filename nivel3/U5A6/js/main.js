...
(function() {
  ...
  U5A6 = (function(_super) {
    ...
    function U5A6() {
      this.manifest = [
        {
          ...
          src: 'TU3_U5_A6_instructions.mp3',
          id: 's/instructions'
        }
      ];
      this.game = {
        ...
        instructions: {
          ...
          states: [
            {
              text: 'Read the dialogs and solve the puzzle with past tense verbs.',
                ...
                [
                  {
                    name: 'cwd1',
                    opts: {
                      matrix: [['#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', 'p', '#'], ['#', '#', '#', 'k', '#', '#', '#', 'd', '#', 'f', '#', '#', 'o', '#'], ['#', '#', '#', 'i', '#', 'w', '#', 'u', '#', 'i', '#', '#', 'l', '#'], ['#', '#', 'l', 'l', '#', 'a', '#', 'm', '#', 'l', '#', '#', 'l', '#'], ['u', 's', 'i', 'l', '#', 's', '#', 'p', '#', 'l', '#', 'p', 'u', 'c'], ['s', 'a', 'v', 'e', '-', 't', 'h', 'e', '-', 'e', 'a', 'r', 't', 'h'], ['e', 'v', 'e', 'd', '#', 'e', '#', 'd', '#', 'd', '#', 'o', 'e', 'a'], ['d', 'e', 'd', '#', '#', 'd', '#', '#', '#', '-', '#', 'd', 'd', 'n'], ['#', 'd', '#', '#', '#', '#', '#', '#', '#', 'u', '#', 'u', '#', 'g'], ['#', '#', '#', '#', '#', '#', '#', '#', '#', 'p', '#', 'c', '#', 'e'], ['#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', 'e', '#', 'd'], ['#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', 'd', '#', '#']],
                      words: [
                        {
                          x: 5,
                          y: 55,
      ...
      U5A6.__super__.constructor.call(this);
    }
