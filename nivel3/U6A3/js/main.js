      ...
      this.manifest = [
        {
          ...
          src: 'TU3_U6_A3_instructions.mp3',
          id: 's/instructions'
        }
      ];
      this.game = {
        ...
        instructions: {
          ...
          states: [
            {
              text: 'Click on the crossword, read the clues and write the answers.',
                ...
                [
                  {
                    name: 'cwd1',
                    opts: {
                      matrix: [['#', '#', '#', '#', '#', '#', '#', '#', '#', 'f', 'o', 'r', 'e', 's', 't'], ['#', '#', '#', '#', '#', '#', '#', '#', '#', '#', 'c', '#', '#', '#', '#'], ['#', '#', '#', '#', '#', '#', '#', 'l', 'a', 'k', 'e', '#', '#', '#', '#'], ['#', '#', '#', '#', '#', '#', 'c', '#', '#', '#', 'a', '#', '#', '#', '#'], ['#', '#', '#', '#', '#', 'v', 'o', 'l', 'c', 'a', 'n', 'o', '#', '#', '#'], ['#', '#', '#', '#', 's', '#', 'n', '#', '#', '#', '#', '#', '#', '#', '#'], ['#', '#', '#', '#', 'w', '#', 't', '#', '#', '#', '#', '#', '#', '#', '#'], ['t', 's', 'u', 'n', 'a', 'm', 'i', '#', '#', '#', '#', '#', '#', '#', '#'], ['#', '#', '#', '#', 'm', '#', 'n', '#', '#', '#', '#', '#', '#', '#', '#'], ['#', '#', '#', '#', 'p', '#', 'e', '#', '#', '#', '#', '#', '#', '#', '#'], ['#', '#', '#', 'i', '#', '#', 'n', '#', '#', '#', '#', '#', '#', '#', '#'], ['#', 'd', 'e', 's', 'e', 'r', 't', '#', '#', '#', '#', '#', '#', '#', '#'], ['#', '#', '#', 'l', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#'], ['l', 'a', 'v', 'a', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#'], ['#', '#', '#', 'n', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#'], ['#', '#', '#', 'd', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#']],
                      words: [
                        {
                          x: 165,
                          y: 0,
