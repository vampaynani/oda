			...
			scenes:[
				{
					answers: {
						collection: [
							[{name:'lbl1', opts:{text:'It\'s three dollars and ten cents.', success:'peach'}}]
							[{name:'lbl1', opts:{text:'They\'re three dollars a kilo.', success:'carrots'}}]
							[{name:'lbl1', opts:{text:'It\'s ninety-five cents.', success:'cream'}}]
							[{name:'lbl1', opts:{text:'It\'s one dollar and fifty cents.', success:'butter'}}]
							[{name:'lbl1', opts:{text:'They\'re two dollars and seventy-five cents.', success:'chilis'}}]
							[{name:'lbl1', opts:{text:'They\'re two dollars and forty cents a kilo.', success:'peppers'}}]
							[{name:'lbl1', opts:{text:'They\'re two dollars and seventy-five cents a kilo.', success:'eggs'}}]
							[{name:'lbl1', opts:{text:'It\'s four dollars and fifty cents.', success:'blueberry'}}]
							[{name:'lbl1', opts:{text:'They\'re four dollars and five cents a kilo.', success:'mushrooms'}}]
						]
						mixed: true
						type: 'steps'
					}
				...
				}
				{
							...
							[
								{
									...
									opts:{
										containers:[
											{type: 'img', name: 'wcpt1_1', success: 'M', img: 'letraM'}
											{type: 'img', name: 'wcpt1_2', success: 'U', img: 'letraU'}
											{type: 'img', name: 'wcpt1_3', success: 'S', img: 'letraS'}
											{type: 'img', name: 'wcpt1_4', success: 'H', img: 'letraH'}
											{type: 'img', name: 'wcpt1_5', success: 'R', img: 'letraR'}
											{type: 'img', name: 'wcpt1_6', success: 'O', img: 'letraO'}
											{type: 'img', name: 'wcpt1_7', success: 'O', img: 'letraO'}
											{type: 'img', name: 'wcpt1_8', success: 'M', img: 'letraM'}
											{type: 'img', name: 'wcpt1_9', success: 'S', img: 'letraS'}
										]
									}
								}
							]
					...
					containers:[
						...
						{type: 'wcpt', id: 'wcpt1', x: 400, y: 494, uwidth: 70, uheight: 60, margin: 5, bcolor: '#FFF', scolor: '#333', stroke: '3', align: 'center'}
						{type: 'drg', id: 'letraM', name: 'letraM', x: 100, y: 100, index: 'M', target: 'wcpt1', afterSuccess: 'hide', afterFail: 'return'}
						{type: 'drg', id: 'letraU', name: 'letraU', x: 100, y: 100, index: 'U', target: 'wcpt1', afterSuccess: 'hide', afterFail: 'return'}
						{type: 'drg', id: 'letraS', name: 'letraS', x: 100, y: 100, index: 'S', target: 'wcpt1', afterSuccess: 'hide', afterFail: 'return'}
						{type: 'drg', id: 'letraH', name: 'letraH', x: 100, y: 100, index: 'H', target: 'wcpt1', afterSuccess: 'hide', afterFail: 'return'}
						{type: 'drg', id: 'letraR', name: 'letraR', x: 100, y: 100, index: 'R', target: 'wcpt1', afterSuccess: 'hide', afterFail: 'return'}
						{type: 'drg', id: 'letraO', name: 'letraO', x: 100, y: 100, index: 'O', target: 'wcpt1', afterSuccess: 'hide', afterFail: 'return'}
						{type: 'drg', id: 'letraO', name: 'letraO2', x: 100, y: 100, index: 'O', target: 'wcpt1', afterSuccess: 'hide', afterFail: 'return'}
						{type: 'drg', id: 'letraM', name: 'letraM2', x: 100, y: 100, index: 'M', target: 'wcpt1', afterSuccess: 'hide', afterFail: 'return'}
						{type: 'drg', id: 'letraS', name: 'letraS2', x: 100, y: 100, index: 'S', target: 'wcpt1', afterSuccess: 'hide', afterFail: 'return'}
					]
				}
			]
		super()
