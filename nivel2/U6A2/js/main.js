...
(function() {
  ...
  U6A2 = (function(_super) {
    ...
    U6A2.prototype.setMap = function(map) {
      ...
      mapa.x = 150;
      mapa.y = 180;
      fondo = this.createBitmap("map" + map, "map" + map, -50, -40);
      ...
      d1 = new Droppable('d1', this.preload.getResult(this.current[0].i), this.current[0].i, 650, 55, this.stage, drops);
      d2 = new Droppable('d2', this.preload.getResult(this.current[1].i), this.current[1].i, 650, 155, this.stage, drops);
      d3 = new Droppable('d3', this.preload.getResult(this.current[2].i), this.current[2].i, 650, 255, this.stage, drops);
