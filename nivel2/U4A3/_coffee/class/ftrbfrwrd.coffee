class AfterBeforeWord
	...
	AfterBeforeWord::initialize = (name, after_label, text, before_label, bgcolor, stcolor, x, y, w, h)->
		...
		@x = x
		@y = y
		@alabel = new createjs.Text after_label, '52px Quicksand', '#333'
		@text = new createjs.Text text,'52px Quicksand','#333'
		@blabel = new createjs.Text before_label, '52px Quicksand', '#333'
