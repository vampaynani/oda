...
var manifest = [
    ...
    {nombre: 'lady', id:'lady' , src: imgurl + 'lady.png'},
    {nombre: 'button', id:'btn' , src: imgurl + 'repeat_btn.png'} ,  
    {nombre: 'guiafondo', id:'guia' , src: imgurl + 'guia.png'}   
];

var manifest2 = [
    {nombre: 'bed', id:'bed' , src: imgurl + 'bed.png'},  
    {nombre: 'broom', id:'broom' , src: imgurl + 'broom.png'},  
    {nombre: 'kitchen', id:'kitchen' , src: imgurl + 'clean-kitchen.png'},  
    {nombre: 'toys', id:'toys' , src: imgurl + 'clean-toys.png'},  
    {nombre: 'cat', id:'cat' , src: imgurl + 'feed-cat.png'},  
    {nombre: 'dog', id:'dog' , src: imgurl + 'feed-dog.png'},  
    {nombre: 'fish', id:'fish' , src: imgurl + 'feed-fish.png'},  
    {nombre: 'garbage', id:'garbage' , src: imgurl + 'out-garbage.png'},  
    {nombre: 'doll', id:'doll' , src: imgurl + 'play-doll.png'},  
    {nombre: 'soup', id:'soup' , src: imgurl + 'soup.png'},  
    {nombre: 'swipe', id:'swipe' , src: imgurl + 'swipe.png'},  
    {nombre: 'walkdog', id:'walkdog' , src: imgurl + 'walk-dog.png'},  
    {nombre: 'dishes', id:'dishes' , src: imgurl + 'wash-dishes.png'},  
    {nombre: 'plants', id:'plants' , src: imgurl + 'water-plants.png'}  
...
function initAssets(){
    ...
    preloadSprite(manifest2, "personajeSps", "personajeAnim", 252, 210, 0, 0, 462,362);
    preloadSprite(manifest2, "personajeSps2", "personajeAnim2", 252, 210, 0, 0, 141, 362);
}
...
function setStage(){
    ...
    createImage("lady",225,138, "mainContainer");
